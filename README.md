...
[실행 도구와 지급 조건](docs/perpl-public-testnet.md)을 준비했고, 같은 도구의 로컬 리허설을 통과했습니다. **실제 공개 거래는 테스트 AUSD 200개 확보 전이라 아직 미실행**입니다. 가스용 MON은 있습니다. `npm run preflight:perpl:testnet`으로 준비 상태를 확인합니다.
